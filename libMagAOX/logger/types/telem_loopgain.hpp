...
struct telem_loopgain : public flatbuffer_log
{
    ...
    {
        if( member == "state" )
            return logMetaDetail( { "LOOP STATE",
                                    logMeta::valTypes::Int,
                                    logMeta::metaTypes::State,
                                    reinterpret_cast<void *>( &state ) } );
        else if( member == "gain" )
            return logMetaDetail( { "LOOP GAIN",
                                    logMeta::valTypes::Float,
                                    logMeta::metaTypes::State,
                                    reinterpret_cast<void *>( &gain ) } );
        else if( member == "multcoef" )
            return logMetaDetail( { "LOOP MULTCOEF",
                                    logMeta::valTypes::Float,
                                    logMeta::metaTypes::State,
                                    reinterpret_cast<void *>( &multcoef ) } );
        else if( member == "limit" )
            return logMetaDetail( { "LOOP LIMIT",
                                    logMeta::valTypes::Float,
                                    logMeta::metaTypes::State,
